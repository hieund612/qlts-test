...
import { MdDownload, MdPanoramaFishEye } from "react-icons/md";
                        ...
                        {innerValue?.map((file: any, index) => {
                            return (
                                <div key={index}>
                                    ...
                                    {
                                        action == 'read' ?
                                            <Modal show={previewFile} loading={previewLoading} size="heightfull">
                                                <>
                                                    <Modal.Header onClose={() => setPreviewFile(false)}>Xem trước {file.title}</Modal.Header>
                                                    <iframe src="https://docs.google.com/gview?url=https://download.microsoft.com/download/1/4/E/14EDED28-6C58-4055-A65C-23B4DA81C4DE/Financial%20Sample.xlsx&embedded=true" frameBorder="0">
                                                    </iframe>
                                                </>
                                            </Modal>
                                            :
