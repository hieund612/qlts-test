...
export default function List() {
  ...
  const { data, isLoading, mutate } = taiSanDatServices.GetList(meta, 1);
      ...
      >
        ...
        >
          ...
          <GridView.Table.Column
            style={{}}
            title="Nhóm tài sản"
            sortKey="tenNhomTaiSan"
            body={({ item }) => <span>{item.tenNhomTaiSan}</span>}
          />
          <GridView.Table.Column
            style={{}}
          ...
          <GridView.Table.Column
            ...
            sortKey="tenNguonGoc"
            body={({ item }) => <span>{item.tenNguonGoc}</span>}
          />
          <GridView.Table.Column
            style={{}}
            title="Trạng thái"
