...
import ThemDonViChothue from "./themdonvichothue";
...
export default function Thongtindenghichothue({ show, action, id, onClose }: IFormProps) {
  ...
  const { data: dataDanhSachTaiSan } = asTaiSanServices.GetById(id!);  
  ...
  const onSubmit = async (values: any) => {
    try {
      values.taiSanId = dataDanhSachTaiSan ? dataDanhSachTaiSan.id : 0; 
      console.log('values',values)  
      // debugger;
      await asChoThueTaiSanServices.createwithfile(values, 'DeNghiChoThueCreateDto', [{ name: 'fileDinhKems', file: 'fileDinhKemAttachs' }]);
      // await asChoThueTaiSanServices.create(values);
                ...
                <Modal.Body nameClass="grid-cols-12 items-center">
                  ...
                  <div className="col-span-9">
                    <TanetInput
                      ...
                      id="tenDonvi"
                      name="tenDonvi"
                      value={dataDanhSachTaiSan ? dataDanhSachTaiSan.tenDonvi : ''}
                    />
                  </div>
                  <div className="col-span-3">
                    <TanetLabel
                  ...
                  <div className="col-span-3">
                    <TanetInput
                      ...
                      id="soTheTaiSan"
                      name="soTheTaiSan"
                      value={dataDanhSachTaiSan ? dataDanhSachTaiSan.soTheTaiSan : ''}
                    />
                  </div>
                  <div className="col-span-6">
                    <TanetInput
                      ...
                      id="tenTaiSan"
                      name="tenTaiSan"
                      value={dataDanhSachTaiSan ? dataDanhSachTaiSan.tenTaiSan : ''}
                    />
                  </div>
                  <div className="col-span-3">
                    <TanetLabel
