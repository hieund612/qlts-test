...
import PhanQuyenGroup from "./components/phanquyen";
...
export default function Page() {
  ...
  return (
    <>
      ...
      <PhanQuyenGroup show={isShowPer}  onClose={onClosePer} action="per-group" id={idGroup}/>
      <UserGroupList show={isShowUpdateUser}  onClose={onClosePer} action="update-user-group" id={idGroup}/>
      <ConfirmationDialog />
    </>
  );
}
