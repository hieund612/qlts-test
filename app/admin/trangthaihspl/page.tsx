...
import { trangThaiHSPLServices } from "./_services/services";
import {
    AiOutlinePlus,
    AiFillEdit,
    AiFillDelete,
...
import TrangThaiHSPLForm from "./_components/trangthaihspl-form";
...
export default function Page() {
    ...
    const { data, isLoading, mutate } = trangThaiHSPLServices.GetList(meta);
    ...
    useEffect(() => {
        setPermisson(getPermisson("trangthaihspl"));
    }, []);
    return (
        <>
                        ...
                        body={({ item }) => (
                            <div className="flex flex-row">
                                ...
                                {permisson.per_Delete && <AiFillDelete
                                    ...
                                    title="Xóa"
                                    onClick={() => delAction(item, trangThaiHSPLServices, data, setMeta, meta, mutate)}
                                />
                                }
                            </div>
                        )}
            ...
            <TrangThaiHSPLForm show={state.show} onClose={onClose} action={state.action} id={state.Id} />
            <ConfirmationDialog />
        </>
    );
}
